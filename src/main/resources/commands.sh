...
docker run -it --name=spark -p 4040:4040 -p 8888:8888 -p 9000:9000 -p 8088:8088 -p 8031:8031 -p 8032:8032 -p 8033:8033 -p 50070:50070 -p 50075:50075 -p 50030:50030 -v $(pwd)/data:/data cithub/spark-yarn
...
# folder for jupyter kernel config /usr/local/share/jupyter/kernels/apache_toree_scala/kernel.json